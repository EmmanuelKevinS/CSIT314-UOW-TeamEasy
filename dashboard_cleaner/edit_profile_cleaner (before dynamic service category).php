...
<div class="container">
    ...
    <?php if ($profile): ?>
        <div class="current-info">
            ...
            <p><strong>Current Services:</strong> <?= htmlspecialchars($profile['service_type']) ?></p>
    ...
    <form method="POST">
        ...
        foreach ($services as $service) {
            ...
            echo "<label><input type='checkbox' name='service_type[]' value='$service' $checked> $service</label><br>";
        }
        ?>
        </div>
